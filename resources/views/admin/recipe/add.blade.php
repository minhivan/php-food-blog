            ...
            <form action="" method="post" class="form-add-recipe my-form" enctype="multipart/form-data">
                ...
                <fieldset class="recipe-title">
                    <div class="title-data input-field">
                        <input type="text" name="title" id="" class="form-control" placeholder="Recipe Title">
                    </div>
                    ...
                    <div class="new-category input-field">
                        ...
                        <div class="recipe-amount">
                            <div id="cookData">
                                ...
                                <div class="cook-time">
                                    <input type="number" class="form-control number" placeholder="    ---" id="cookTime" name="cookTime">
                            ...
                            <div id="serveData">
                                ...
                                <div class="serve-time">
                                    <input type="number" class="form-control number" placeholder="    ---" id="serveTime" name="serveFor">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset class="recipe-steps">
                    ...
                    <div class="descData input-field">
                        <textarea class="form-control" placeholder="Recipe Description" name="direction"></textarea>
                    </div>
                </fieldset>
                <fieldset class="recipe-submit">
                    ...
                    <div class="submitSection">
                        ...
                        <div class="or-cancel">or <button id="cancelRecipe" class="button" type="reset">Cancel</button></div>
                    </div>
                </fieldset>
            </form>
        </div>
